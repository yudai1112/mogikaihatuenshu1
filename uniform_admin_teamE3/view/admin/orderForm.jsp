...
<body>
	...
	<form action="<%=request.getContextPath()%>/orderForm" class="order"
		oninput="result.value=parseInt(sSize.value) + parseInt(mSize.value)+ parseInt(lSize.value)+ parseInt(kidsSize.value);">
		<table style="margin: auto" class="product-table">
			...
			<tr>
				<th>サイズS</th>
				<td><input type="number" value="0" min="0" max="100" step="1"
					name="sSize"></td>
			<tr>
			<tr>
				<th>サイズM</th>
			...
			<tr>
				<th>合計注文数</th>
				<td><output name="result">0</output></td>
			</tr>
			<tr>
				<th>備考</th>
		...
		<p style="text-align: center">
			<a href="showCart.jsp" class="btn_03">カートに入れる</a>
		</p>
		<br>
	</form>
	<p>
