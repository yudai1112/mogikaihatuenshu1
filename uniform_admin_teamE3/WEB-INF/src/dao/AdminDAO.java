...
//  -------------------------------------------------------------------------------------------
	 ...
	 * 『 selectByUser 』
	 *
	 * DBのuserinfoテーブルから指定ユーザーとパスワードの条件に合致する情報を取得
	 *
	 * @param userid
	 * @return userオブジェクト
	 */
	public Admin selectByUser(String id, String password) {
		...
		try {
			...
			//sql文
			String sql = "SELECT * FROM administrator_info WHERE administrator_id ='"+id+"' AND password='"+password+"'";
